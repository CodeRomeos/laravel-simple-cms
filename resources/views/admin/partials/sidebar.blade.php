  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li><a href="pages/UI/general.html"><i class="fa fa-circle-o"></i> All Pages</a></li>
        <li><a href="pages/UI/icons.html"><i class="fa fa-circle-o"></i> Create Page</a></li>
      </ul>
    </li>
	<li class="treeview">
      <a href="#">
      ...
      <ul class="treeview-menu">
        ...
        <li><a href="{{ route('admin.categories.index', 'create') }}"><i class="fa fa-circle-o"></i> Create Category</a></li>
      </ul>
    </li>
    <li class="treeview">
      <a href="#">
